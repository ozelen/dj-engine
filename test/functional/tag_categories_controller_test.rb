...
class TagCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create tag_category" do
    assert_difference('TagCategory.count') do
      post :create, tag_category: { filter: @tag_category.filter, name: @tag_category.name, parent_id: @tag_category.parent_id }
    end
  ...
  test "should update tag_category" do
    put :update, id: @tag_category, tag_category: { filter: @tag_category.filter, name: @tag_category.name, parent_id: @tag_category.parent_id }
    assert_redirected_to tag_category_path(assigns(:tag_category))
  end
