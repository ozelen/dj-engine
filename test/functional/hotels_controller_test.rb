...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { city_id: @hotel.city_id, description: @hotel.description, location: @hotel.location, name: @hotel.name }
    end
  ...
  test "should update hotel" do
    put :update, id: @hotel, hotel: { city_id: @hotel.city_id, description: @hotel.description, location: @hotel.location, name: @hotel.name }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
