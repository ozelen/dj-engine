...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { description: @period.description, name: @period.name, order_position: @period.order_position, since: @period.since, till: @period.till }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { description: @period.description, name: @period.name, order_position: @period.order_position, since: @period.since, till: @period.till }
    assert_redirected_to period_path(assigns(:period))
  end
