...
class RedirectsControllerTest < ActionController::TestCase
  ...
  test "should create redirect" do
    assert_difference('Redirect.count') do
      post :create, redirect: { new_path: @redirect.new_path, old_domain: @redirect.old_domain, old_path: @redirect.old_path }
    end
  ...
  test "should update redirect" do
    put :update, id: @redirect, redirect: { new_path: @redirect.new_path, old_domain: @redirect.old_domain, old_path: @redirect.old_path }
    assert_redirected_to redirect_path(assigns(:redirect))
  end
