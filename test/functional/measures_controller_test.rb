...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { iso: @measure.iso, measure_category_id: @measure.measure_category_id, name: @measure.name }
    end
  ...
  test "should update measure" do
    put :update, id: @measure, measure: { iso: @measure.iso, measure_category_id: @measure.measure_category_id, name: @measure.name }
    assert_redirected_to measure_path(assigns(:measure))
  end
